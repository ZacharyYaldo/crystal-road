...
const EXPORTS=['G','update','xpNeed','partyState','partyPower','ZONES','HEROES','CLASSES','TALENTS','ENEMIES','OMENS','SUPER_ORDER','BUILD','STRUCTS','OATHS','equipBest','ascendItem','ascendCost','ascendCap','buyTalent','promoteHero','promoteReq','rankCost','talentReq','treeLv','buildCost','hireCost','vilCap','idleVil','garrisonHeroes','postHero','postLeft','recallHero','garrisonSlots','startHordeFight','hordeWindow','hordeThreat','hordeTier','defense','prepCost','mercLv','startDelve','chooseDoor','endDelve','canReforge','doReforge','zoneUnlocked','reqReforge','goZone','reforgeGain','offlineGains','fmtNum','makeItem','salvageItem','goldMult','oreMult','xpMult','tapRateMult','migrateSave','nodeCost','buyTreeRank','restHealPct','restHealAt','dustBlessMult','dustBlessAt','critChance','actionSpeedMult','offlineReport','nodeTotal','CRIT_CAP','shatterGoldComp','shatterOreComp','refMult','speedNow','buySpeed4','itemLvlCap','reforgeNeedWave','tapCastHero','noteAttention','attnOn','attnMult','abilityAction','ASCEND_BASE','AUTO_CAST_POWER','MANUAL_CAST_POWER','ITEM_LVL_PER_RANK','SHATTER_WAVE_STEP','makeItem','ascendItem','upgradeItem','upgradeCost','tapEnemy','reactTo','abilityPower','startDrill','drillTick','endDrill','withDrill','tickUnits','battleStep','DRILL','DRILL_SEC','DRILL_UI','serialize','chooseAction','drillBrackets','drillBracketKey','drillDef','drillTier','drillTarget','drillThreshold','drillRecords','drillBundle','drillBundleDiff','drillRound','drillPoolHp','drillCrystal','drillPortion','drillPortionMult','DEV_TOOLS','resolveHorde','startHordeFight','warpGains','drillRate','drillRewardAmounts','drillProvisional','drillRewardsOn','drillLive','openTraining','incomeRate','permGoldMult','permOreMult','offlineGains','seededRng','zoneUnlocked','enemyStats','goldMult','oreMult','oreScale','zoneBonus','bless','roadLv','endlessLv','ORE_DROP_CHANCE','abortDrill','loadGame','storeSet','storeGet','killReward','grabTreasure','delveWin','endBattle','questEvent','orePerHour','goldPerHour','useWarp','openDailyChest','doubleOffline','QUESTS','startQuest','collectQuest','questSlots','questDur','keysNow','keyMax','keyPeriod','living','salvageValue','refreshStats','layout','castleTick','checkUnlocks','partyMax','xpNeed','tal','built','endlessLv','endlessMilestone','bossZone','renownGain','offerOmens','milestoneItem','serialize','loadGame','saveGame','storeSet','storeGet','itemName','itemStat','upgradeCost','upgradeItem','heroStats','setAnim','banner','toast','closeSheet','openSheet','spawnEncounter','resolveHorde','genHorde','hordeStrength','currentRoadLevel','hordeCombatLevel','TREE','NODES','tabLocked','heroStatus','tapEnemy','tapDamage','castSurge','reactTo','autoOn','addHero','mkHero'];
