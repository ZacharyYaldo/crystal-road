...
const EXPORTS=['G','update','xpNeed','partyState','partyPower','ZONES','HEROES','CLASSES','TALENTS','ENEMIES','OMENS','SUPER_ORDER','BUILD','STRUCTS','OATHS','equipBest','ascendItem','ascendCost','ascendCap','buyTalent','promoteHero','promoteReq','rankCost','talentReq','treeLv','buildCost','hireCost','vilCap','idleVil','garrisonHeroes','postHero','postLeft','recallHero','garrisonSlots','startHordeFight','hordeWindow','hordeThreat','hordeTier','defense','prepCost','mercLv','startDelve','chooseDoor','endDelve','canReforge','doReforge','zoneUnlocked','reqReforge','goZone','reforgeGain','offlineGains','fmtNum','makeItem','salvageItem','goldMult','oreMult','xpMult','tapRateMult','migrateSave','salvageValue','refreshStats','layout','castleTick','checkUnlocks','partyMax','xpNeed','tal','built','endlessLv','endlessMilestone','bossZone','renownGain','offerOmens','milestoneItem','serialize','loadGame','saveGame','storeSet','storeGet','itemName','itemStat','upgradeCost','upgradeItem','heroStats','setAnim','banner','toast','closeSheet','openSheet','spawnEncounter','resolveHorde','genHorde','hordeStrength','currentRoadLevel','hordeCombatLevel','TREE','NODES','tabLocked','heroStatus','tapEnemy','tapDamage','castSurge','reactTo','autoOn','addHero','mkHero'];
