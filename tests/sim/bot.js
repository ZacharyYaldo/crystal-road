...
const RETREAT_AFTER=args.noRetreat?0:(args.retreatAfter==null?4:Number(args.retreatAfter)),TRAIN_MODE=String(args.trainUntil||'level'),RETREAT_ON=String(args.retreatOn||'boss');
