...
function trackFor(){const Z=ZONES[G.zone]||ZONES[0];const zi=Z.endless?endSeg(G.prog[G.zone]||0):G.zone;const M=ASSETS.music||{};const k=['greenhollow','lagoon','thornwood','ironvein','emberwaste','amberfall','ashen'][zi]||'greenhollow';return M[k]?k:'greenhollow';}
