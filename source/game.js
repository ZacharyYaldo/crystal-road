...
cv.addEventListener('pointerup',endDrag);cv.addEventListener('pointercancel',()=>{G.drag=null;HOLD=null;});window.addEventListener('pointerup',()=>{HOLD=null;toastTouch=null;});window.addEventListener('pointercancel',()=>{HOLD=null;});window.addEventListener('blur',()=>{HOLD=null;});cv.addEventListener('pointerleave',()=>{HOLD=null;});
