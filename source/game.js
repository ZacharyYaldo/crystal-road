...
function itemStat(it){const rf=1+0.1*(G.reforges||0),base=it.slot==='weapon'?6:it.slot==='cape'?3:12;return R(base*Math.pow(2.2,it.rank)*Math.pow(ITEM_LVL_GROWTH,it.lvl)*rf);}
