...
function spendCall(fn,x,y,r){const g0=G.gold,o0=G.ore,d0=G.dust;fn();if(G.gold<g0||G.ore<o0||G.dust<d0){sfx('coin',true);if(r){const P=G.uparts||(G.uparts=[]),cx=r.x+r.w/2,cy=r.y+r.h/2;for(let k=0;k<12;k++){const a=rand()*Math.PI*2,sp=30+rand()*50;P.push({x:cx+(rand()*8-4),y:cy+(rand()*4-2),vx:Math.cos(a)*sp,vy:Math.sin(a)*sp-30,life:0.45+rand()*0.4,col:[C.goldL,C.gold,'#fff','#ffb36b'][k%4],big:true});}}else uiSparks(x,y,8);}}
